...
$__Context->_logo_img = 's_logo.png';
					...
					<li class="hover">
						<?php if($__Context->is_logged){ ?>
							...
							<a href="<?php echo getUrl('act', 'dispMemberInfo') ?>" class="login_after">
								...
								<?php }else{ ?>
									<img src="/dev/layouts/xedition/img/ico_default.jpg" alt="<?php echo $__Context->logged_info->nick_name ?>" />
								<?php } ?>
							</a>
							<div class="ly ly_login">
								<ul>
									<?php $__loop_tmp=$__Context->logged_info->menu_list;if($__loop_tmp)foreach($__loop_tmp as $__Context->key=>$__Context->val){ ?><li><a href="<?php echo getUrl('act', $__Context->key, 'member_srl', '', 'page', '') ?>"><?php echo lang($__Context->val) ?></a></li><?php } ?>
			...
			<?php if($__Context->_enable_unb && $__Context->UNB->list){ ?><div class="custom_area">
				<ul>
					<?php $__loop_tmp=$__Context->UNB->list;if($__loop_tmp)foreach($__loop_tmp as $__Context->key=>$__Context->val){ ?><li>
			...
			<?php if($__Context->GNB->list){ ?><nav class="gnb" id="gnb">
				...
				<ul>
					<?php $__loop_tmp=$__Context->GNB->list;if($__loop_tmp)foreach($__loop_tmp as $__Context->key1=>$__Context->val1){ ?><li>
...
$__Context->_selected_menu = $__Context->val1;
						...
						<?php if($__Context->val1['list']){ ?><ul class="depth2">
							<?php $__loop_tmp=$__Context->val1['list'];if($__loop_tmp)foreach($__loop_tmp as $__Context->key2=>$__Context->val2){ ?><li<?php if($__Context->val2['list']){ ?> class="more"<?php } ?>>
								...
								<?php if($__Context->val2['list']){ ?><ul class="depth3">
									<?php $__loop_tmp=$__Context->val2['list'];if($__loop_tmp)foreach($__loop_tmp as $__Context->key3=>$__Context->val3){ ?><li>
...
$__Context->_subheader_img = 'sub_banner_xeicon.jpg';
	...
	<div class="body <?php echo $__Context->_body_class ?>">
		...
		<?php if(isset($__Context->_selected_menu['list']) && $__Context->_selected_menu['list'] && $__Context->layout_info->layout_type === 'sub' && $__Context->layout_info->sidebar_position !== 'none'){ ?><nav class="lnb">
			<ul>
				<?php $__loop_tmp=$__Context->_selected_menu['list'];if($__loop_tmp)foreach($__loop_tmp as $__Context->key1=>$__Context->val1){ ?><li>
					<a href="<?php echo $__Context->val1['href'] ?>"<?php if($__Context->val1['open_window'] == 'Y'){ ?> target="_blank"<?php } ?>><?php echo $__Context->val1['link'] ?></a>
					<?php if($__Context->val1['list']){ ?><ul>
						<?php $__loop_tmp=$__Context->val1['list'];if($__loop_tmp)foreach($__loop_tmp as $__Context->key2=>$__Context->val2){ ?><li<?php if($__Context->val2['selected']){ ?> class="on"<?php } ?>>
							<a href="<?php echo $__Context->val2['href'] ?>"<?php if($__Context->val2['open_window'] == 'Y'){ ?> target="_blank"<?php } ?>><?php echo $__Context->val2['link'] ?></a>
						</li><?php } ?>
					</ul><?php } ?>
				</li><?php } ?>
			...
			<div class="f_info2">
				<div class="site_map">
					<?php if($__Context->FNB->list){ ?><ul>
						<?php $__Context->i = 0 ?>
						<?php $__loop_tmp=$__Context->FNB->list;if($__loop_tmp)foreach($__loop_tmp as $__Context->key1=>$__Context->val1){ ?><li<?php if(!($__Context->i % 3) && $__Context->i > 0){ ?> class="clear"<?php } ?>>
							<?php $__Context->i++ ?>
							<a href="<?php echo $__Context->val1['href'] ?>"<?php if($__Context->val1['open_window'] == 'Y'){ ?> target="_blank"<?php } ?>><?php echo $__Context->val1['link'] ?></a>
							<?php if($__Context->val1['list']){ ?><ul>
								<?php $__loop_tmp=$__Context->val1['list'];if($__loop_tmp)foreach($__loop_tmp as $__Context->key2=>$__Context->val2){ ?><li>
									<a href="<?php echo $__Context->val2['href'] ?>"<?php if($__Context->val2['open_window'] == 'Y'){ ?> target="_blank"<?php } ?>><?php echo $__Context->val2['link'] ?></a>
								</li><?php } ?>
							</ul><?php } ?>
						</li><?php } ?>
...
echo $lang->email_address;
					...
					<div class="control-group">
						...
						<?php if(isset($__Context->captcha) && $__Context->captcha && $__Context->captcha->isTargetAction('login')){ ?><div class="captcha">
