<?php if(!defined("__XE__"))exit;?><script src="/dev/modules/board/tpl/js/board_admin.js"></script>
<script src="/dev/modules/board/tpl/modules/module/tpl/js/module_admin.js"></script>
<script>
</script>
	...
	<div class="x_control-group">
		...
		<div class="x_controls">
			<select name="order_target" id="order_target" title="<?php echo $lang->order_target ?>">
				<?php $__loop_tmp=$__Context->order_target;if($__loop_tmp)foreach($__loop_tmp as $__Context->key=>$__Context->val){ ?><option value="<?php echo $__Context->key ?>"<?php if($__Context->module_info->order_target== $__Context->key){ ?> selected="selected"<?php } ?>><?php echo $__Context->val ?></option><?php } ?>
			</select>
