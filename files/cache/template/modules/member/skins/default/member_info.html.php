...
<dl class="dl-horizontal">
	<?php $__loop_tmp=$__Context->displayDatas;if($__loop_tmp)foreach($__loop_tmp as $__Context->item){ ?>
...
<?php if($__Context->memberInfo['member_srl'] == $__Context->logged_info->member_srl){ ?><div class="btnArea btn-group">
	...
	<a href="<?php echo getUrl('act','dispMemberModifyEmailAddress') ?>" class="btn"><?php echo $lang->cmd_modify_member_email_address ?></a>
