			...
			<tr>
				<th colspan="8" scope="col">
					...
					<?php }else{ ?>
						...
						<?php if($__Context->val->module_srl && isset($__Context->module_list[$__Context->val->module_srl])){ ?>
...
<form action="./" method="get" onsubmit="return checkSearch(this)" class="search center x_input-append"><input type="hidden" name="mid" value="<?php echo $__Context->mid ?? ''; ?>" />
	<input type="hidden" name="module" value="<?php echo $__Context->module ?>" />
	<input type="hidden" name="act" value="<?php echo $__Context->act ?>" />
	...
	<select name="search_target" title="<?php echo $lang->search_target ?>" style="margin-right:4px">
		<?php if(lang('file.file_search_target_list'))foreach(lang('file.file_search_target_list') as $__Context->key => $__Context->val){ ?>
...
<?php Context::addJsFile("modules/file/ruleset/deleteChecked.xml", FALSE, "", 0, "body", TRUE, "") ?><form  action="./" method="post" class="x_modal" id="listManager"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?? ''; ?>" /><input type="hidden" name="ruleset" value="deleteChecked" />
	<input type="hidden" name="module" value="file" />
