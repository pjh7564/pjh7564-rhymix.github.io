<?php if(!defined("__XE__"))exit;?><!--#Meta:modules/widget/tpl/js/widget.js--><?php Context::loadFile(['modules/widget/tpl/js/widget.js', '', '', '']); ?>
<!--#Meta:modules/widget/tpl/css/widget.css--><?php Context::loadFile(['modules/widget/tpl/css/widget.css', '', '', '', []]); ?>
<form action="./" method="get" onsubmit="return addContentWidget(this); return false;" id="content_fo"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="act" value="<?php echo $__Context->act ?? ''; ?>" />
	...
	<div class="x_modal-header">
		<h1><?php echo $lang->cmd_content_insert ?></h1>
	</div>
	...
	<div class="x_modal-footer">
		<input type="submit" value="<?php echo $lang->cmd_save ?>" class="x_btn x_btn-inverse" />
	</div>
</form>
