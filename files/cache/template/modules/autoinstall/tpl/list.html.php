...
<div id="__list_simple">
	<?php if($__Context->isNotUpdate){ ?>
	<div class="message error">
		<p><?php echo $lang->msg_connection_fail ?></p>
	</div>
	<?php } ?>
...
echo $__Context->current_category;
	...
	<div class="list">
		<?php $__loop_tmp=$__Context->item_list;if($__loop_tmp)foreach($__loop_tmp as $__Context->key=>$__Context->item){ ?>
...
echo $__Context->current_category;
	...
	<tbody>
		<?php $__loop_tmp=$__Context->item_list;if($__loop_tmp)foreach($__loop_tmp as $__Context->key=>$__Context->item){ ?><tr>
			<?php  $__Context->target_url = $__Context->original_site."?mid=download&package_srl=".$__Context->item->package_srl;  ?>
			<td>
...
echo sprintf($lang->rate, $__Context->item->package_start) ?></span></span>
				...
				<?php if($__Context->item->deps){ ?><ul class="">
					<?php $__loop_tmp=$__Context->item->deps;if($__loop_tmp)foreach($__loop_tmp as $__Context->package_srl){ ?><li><?php echo $__Context->installed[$__Context->package_srl]->title ?></li><?php } ?>
				</ul><?php } ?>
			</td>
...
<div class="x_clearfix" style="margin-top:-10px">
	<?php if($__Context->page_navigation){ ?><form action="./" class="x_pagination x_pull-left" ><input type="hidden" name="mid" value="<?php echo $__Context->mid ?? ''; ?>" />
	...
	<?php if($__Context->act !== 'dispAutoinstallAdminInstalledPackages'){ ?><form action="./" class="search x_input-append x_pull-right" ><input type="hidden" name="mid" value="<?php echo $__Context->mid ?? ''; ?>" />
		<input type="hidden" name="module" value="admin" />
		<input type="hidden" name="act" value="<?php echo $__Context->act ?>" />
		<input type="hidden" name="order_target" value="<?php echo $__Context->order_target ?>" />
		<input type="hidden" name="order_type" value="<?php echo $__Context->order_type ?>" />
