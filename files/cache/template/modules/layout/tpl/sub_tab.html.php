...
<div>
	<a<?php if($__Context->act == 'dispLayoutAdminAllInstanceList'){ ?> class="active"<?php } ?> href="<?php echo getUrl('act', 'dispLayoutAdminAllInstanceList', 'layout_srl', '') ?>"><?php echo $lang->instance_layout ?></a> <i>|</i>
	<a<?php if($__Context->act == 'dispLayoutAdminInstalledList'){ ?> class="active"<?php } ?> href="<?php echo getUrl('act', 'dispLayoutAdminInstalledList') ?>"><?php echo $lang->installed_layout ?></a>
</div>
