...
v.cast('ADD_FILTER',['insertAdminMember', {'user_id':{rule:'userid'},'email_address':{required:true,rule:'email'},'password':{'if':[{test:'!$member_srl', attr:'required', value:'true'},{test:'!$member_srl', attr:'length', value:'3:20'}]},'nick_name':{required:true}}]);
