...
v.cast('ADD_RULE', ['number_with_plus_minus', /^(\+|-)?[0-9][0-9]*$/]);
v.cast('ADD_FILTER',['updatePoint', {'member_srl':{required:true,rule:'number'},'point':{required:true,rule:'number_with_plus_minus'}}]);
v.cast('ADD_MESSAGE',['point','포인트']);
