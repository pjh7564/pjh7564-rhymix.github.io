...
$layout_info->title = 'XE Face off 레이아웃';
$layout_info->description = 'XE FaceOff 레이아웃입니다.';
...
$layout_info->extra_var->logo_text->description = '레이아웃의 상단에 표시될 로고 글자를 입력해주세요. 로고 이미지가 있으면 표시되지 않습니다.';
$layout_info->extra_var->copyright_text = new stdClass;
$layout_info->extra_var->copyright_text->group = NULL;
$layout_info->extra_var->copyright_text->title = '카피라이트 문구';
$layout_info->extra_var->copyright_text->type = 'text';
$layout_info->extra_var->copyright_text->value = $vars->copyright_text;
$layout_info->extra_var->copyright_text->description = '하단에 표시될 카피라이트 문구를 설정할 수 있습니다';
