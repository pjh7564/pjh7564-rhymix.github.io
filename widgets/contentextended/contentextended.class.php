<?php
    ...
    class contentextended extends WidgetHandler {
        ...
        function proc($args) {
            ...
            // $args의 프로세스 내 변조를 복구시킴. - JHS (120901)
            $bkv_module_srl = $args->module_srl;
            $bkv_category_srl = $args->category_srl;
            ...
            // $args의 프로세스 내 변조를 복구시킴. - JHS (120901)
            $args->module_srl = $bkv_module_srl;
            $args->category_srl = $bkv_category_srl;
        ...
        function _getDocumentItems($args){
            ...
            if($getcount > 0) {
                ...
                for($i=0,$c=count($document_srls);$i<$c;$i++) {
					...
					if ($args->extravar2_name) $content_item->setExtraVar2($oDocument->getExtraEidValueHTML($args->extravar2_name));
					if ($args->extravar3_name) $content_item->setExtraVar3($oDocument->getExtraEidValueHTML($args->extravar3_name));
					if ($args->extravar4_name) $content_item->setExtraVar4($oDocument->getExtraEidValueHTML($args->extravar4_name));
					if ($args->extravar5_name) $content_item->setExtraVar5($oDocument->getExtraEidValueHTML($args->extravar5_name));
    ...
    class contentextendedItem extends BaseObject {
